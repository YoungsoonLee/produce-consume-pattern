...
const porducerCount int = 3
const consummerCount int = 3
...
func exec(jobQ chan<- string, workerPool chan *producers, allDone chan<- bool) {
...
func main() {
	...
	go exec(jobQ, workerPool, allDone)

	for i := 0; i < consummerCount; i++ {
